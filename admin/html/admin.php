            ...
            <section class="content">
                ...
                <?php
                    ...
                    if($_GET['page']!=1) 
                    {
                        ...
                        echo "<a href='$_SERVER[PHP_SELF]?page=$back'><i class='fas fa-caret-left'></i></a>";
                    }
                    for($i=$start_page; $i<=$end_page; $i++)
                    {
                    if($_GET['page']!=$i) 
                    {
                        echo "<a class='list__page' href='$_SERVER[PHP_SELF]?page=$i'>";
                    }
                    ...
                    if($_GET['page']!= $total_page)
                    {
                        ...
                        echo "<a href='$_SERVER[PHP_SELF]?page=$next'><i class='fas fa-caret-right'></i></a>";
                    }
                ?>
